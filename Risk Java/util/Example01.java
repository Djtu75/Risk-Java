...
public class Example01 extends Frame {
    ...
    private void renderWorldWithRects(int[][] toparr, Color[] colors, Graphics2D graphObj) {
        int colorindex = 0;
        for(int[] array: toparr){
            ...
            path.closePath();
            setPaintColor("gradient", colors[colorindex%colors.length], colors[(colorindex+1)%colors.length], left, top, right, bottom, graphObj);
            graphObj.fill(path);
            colorindex++;
        ...
        for(int[] array: toparr){
            ...
            renderSoldierCount(xavg, yavg, 15, graphObj);
        }
