...
public interface Logic {
    ...
    public ArrayList<placeTroop> draftPhase(int numTroopstoPlace); //Asks player to place troops. Should return [int numTroopstoPlace, Province destination]
    public attack attackPhase(); //Asks player to perform attack. Should return [int numTroopstoUse, Province attackingProvince, Province defendingProvince]
    public moveTroop movePhase(); //Asks player to move troops. Should return [int numTroopstoMove, Province source, Province destination]
    ...
    public Set<Card> turnInCards(int currentTroops); //Asks player to turn in set of cards. If required, must be [Card X, Card Y, Card Z]. If optional, any invalid input will count as passing on your turn.
